	...
	return (
		<Section
			...
			header={{
				...
				description:
					"A numeric input with optional increment/decrement buttons.",
			}}
		>
			<div class="grid gap-6">
				<DemoCard title="Basic" description="Simple number input">
					<div class="max-w-xs space-y-4">
						...
						<div class="text-sm text-text-secondary">
							Value:{" "}
							<span class="font-mono text-primary-500">{quantity()}</span>
						</div>
					</div>
				</DemoCard>
				...
				<DemoCard
					...
					description="Currency, units, etc."
				>
					<div class="max-w-xs space-y-4">
						<NumberInput
							value={price()}
				...
				<DemoCard title="Validation" description="Error state with message">
					<div class="max-w-xs space-y-4">
						<NumberInput
							...
							min={18}
							errorMessage={
								age() < 18 ? "Must be at least 18 years old" : undefined
							}
							required
						/>
					</div>
