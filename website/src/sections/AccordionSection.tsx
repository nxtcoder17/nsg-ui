    ...
    >
        ...
        <div class="max-w-lg">
          <Accordion collapsible>
            ...
            <Accordion.Item value="item-2">
              ...
              <Accordion.Content>Absolutely. The component accepts class props and uses data attributes for state-based styling.</Accordion.Content>
            </Accordion.Item>
      ...
      <DemoCard title="Controlled" description="Control expanded state externally">
        <div class="max-w-lg space-y-4">
          <Accordion value={expanded()} onChange={setExpanded} multiple collapsible>
            <Accordion.Item value="item-1">
              <Accordion.Trigger>Is it accessible?</Accordion.Trigger>
              <Accordion.Content>Yes! The accordion follows WAI-ARIA design patterns and supports full keyboard navigation.</Accordion.Content>
            </Accordion.Item>
            ...
            <Accordion.Item value="installation">
              ...
              <Accordion.Content>
                <div class="space-y-2">
                  ...
                  <pre class="bg-neutral-100 p-2 rounded text-xs font-mono">bun add nsg-ui</pre>
                </div>
              </Accordion.Content>
            </Accordion.Item>
