...
// Navigation icons
export function ButtonIcon(props: IconProps): JSX.Element {
  return (
...
export function DialogIcon(props: IconProps): JSX.Element {
  return (
    <svg class={props.class} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
...
export function PopoverIcon(props: IconProps): JSX.Element {
  return (
    <svg class={props.class} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
...
export function LayersIcon(props: IconProps): JSX.Element {
  return (
    <svg class={props.class} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
